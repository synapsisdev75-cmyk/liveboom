...
export const LEGAL_DOCS: LegalDoc[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Los coins son créditos virtuales para uso dentro de la plataforma. Las compras procesadas por proveedores de pago (por ejemplo Wompi) están sujetas a sus políticas. El retiro de Blast ganados a pesos colombianos (COP) se calcula según el equivalente de retiro vigente para creadores, sujeto a verificación de identidad y medios de pago. Los reembolsos se evalúan según la ley aplicable y las políticas de la tienda de pagos.',
      },
      {
