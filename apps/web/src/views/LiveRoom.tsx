...
function CreatorStage({
  ...
  // Heartbeat cada 18s; reconcile de viewers cada 36s (menos getDocs masivos).
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={
          isHost
            ? `lb-live-stage-hud pointer-events-none absolute inset-x-0 top-0 z-10 bg-gradient-to-b from-black/70 to-transparent px-3 pb-6 pt-[env(safe-area-inset-top,0px)] sm:px-4${aspectRatio === '9:16' ? ' is-letterbox' : ''}${verticalHost ? '' : ' lg:pb-10'}`
